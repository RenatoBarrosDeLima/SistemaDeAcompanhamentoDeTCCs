                ...
                <div class="content">
                    <div class="col-md-10">
                        <div class="card">
                            <div class="header">
                                <br>
                                <div align="center"> <h4 class="title">Editar Perfil</h4> 
                                </div>
                                    ...
                                    <form class="form-signin" id="formulario" action= "../controller/criarSenhaUsuario.php" method="post">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Matrícula" required disabled=""  autofocus name="matricula">
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Curso</label>
                                                    <select class="form-control" disabled="" placeholder="Escolha o seu Curso" name="curso" required >
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" disabled placeholder="Escolha o seu Curso" name="funcao" required >
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" disabled="" class="form-control" placeholder="Ex: 2017.1" required name="periodo">
                                                </div>
                                            </div>
                                        </div>
